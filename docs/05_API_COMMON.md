...
게임서버 ↔ Coupon Platform 간 S2S 호출 규약은 [04_AUTH_SECURITY.md](./04_AUTH_SECURITY.md) 2장을 따른다. 사용자 인증(토큰/세션) 정책은 [04_AUTH_SECURITY.md](./04_AUTH_SECURITY.md) 1장에 정의되어 있으며, 본 문서에서는 반복하지 않는다.
...
세부 정책은 [04_AUTH_SECURITY.md](./04_AUTH_SECURITY.md) 1.4 참고.
...
세부 정책은 [04_AUTH_SECURITY.md](./04_AUTH_SECURITY.md) 1.3 참고.
