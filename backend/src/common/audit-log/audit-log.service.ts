...
/** 감사 대상 테이블(15_LOG_AUDIT_API.md 2.1) — coupon_campaign/coupon_code 등은 별도 로그로 관리하므로 여기 포함하지 않는다. */
 ...
 * 이미 계산해 반환한 값을 그대로 옮기기만 하면 된다(04_DEV_CONVENTIONS.md 3.2, "SP 내부 캡처"
 * 방식 참고).
 */
 ...
 * JSON 직렬화 같은 세부사항을 한 곳에서만 관리한다(04_DEV_CONVENTIONS.md 2장 모듈화 원칙).
 *
 * @author trisakion
 */
@Injectable()
export class AuditLogService {
   ...
   * 메인 트랜잭션에 영향을 주면 안 된다는 04_DEV_CONVENTIONS.md 1장 원칙) fire-and-forget으로
