...
/** 10_API_COMMON.md 2.3: 허용되는 page_size 값. */
export const PAGE_SIZE_OPTIONS = [20, 30, 50, 100] as const;
export type PageSize = (typeof PAGE_SIZE_OPTIONS)[number];

/**
 * 10_API_COMMON.md 2장 페이지네이션 정책. 목록 조회 API의 쿼리 파라미터로 사용.
 *
 * @author trisakion
 */
...
/** 10_API_COMMON.md 2.4의 목록 응답 셰이프. */
...
/**
 * 조회된 페이지 데이터를 10_API_COMMON.md 2.4 응답 형식으로 감싼다.
 *
