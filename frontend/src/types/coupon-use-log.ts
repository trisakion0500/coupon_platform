...
/** 06_DATABASE_SCHEMA.md 11장 — log_coupon_use.action. 10:RESERVE/20:CONFIRM. */
export type CouponUseAction = 10 | 20;

/** 06_DATABASE_SCHEMA.md 11장 — log_coupon_use.result_type.
 * 0:성공/10:코드없음/20:이미소모·중지/30:캠페인 사용불가/40:사용자한도초과/50:소모기록없음(CONFIRM 전용). */
export type CouponUseResultType = 0 | 10 | 20 | 30 | 40 | 50;

/** 19_CAMPAIGN_API.md 4.3 GET /coupon-use-logs 응답 items 항목. campaign_name은
...
/** 19_CAMPAIGN_API.md 4.3 쿼리 파라미터. project_id는 헤더의 전역 프로젝트 선택을 그대로 쓴다
 * (17_SCREEN_LIST.md SCR-103). */
