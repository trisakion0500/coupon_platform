...
export type UnconfirmedResult = UnconfirmedResultSingleUser | UnconfirmedResultPaginated;
...
export declare class CouponApiError extends Error {
    readonly resultCode: number;
    readonly httpStatus: number;
    constructor(resultCode: number, httpStatus: number, message: string);
}
export declare class CouponS2sClient {
     ...
     */
    getUnconfirmed(params?: GetUnconfirmedParams): Promise<UnconfirmedResult>;
    /**
